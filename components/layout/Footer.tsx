...
export function Footer() {
  ...
  const footerLinks = {
    Products: [
      ...
      { label: "Buck Regulator", href: "/products/buck-regulator", icon: null },
      { label: "LDO Regulator", href: "/products/ldo-regulator", icon: null },
      { label: "LED Driver", href: "/products/led-driver", icon: null },
      {
        label: "Ideal Diode Controller",
        href: "/products/ideal-diode-controller",
        icon: null,
      },
      { label: "Load Switch", href: "/products/load-switch", icon: null },
    ],
    Company: [
      { label: "About Us", href: "/about", icon: null },
      { label: "Blog", href: "/blog", icon: null },

...
export default function AdminAnalyticsPage() {
  ...
  const stats = [
    { label: 'Total Visitors', value: totalVisitors, change: '+23%', icon: Users, color: 'blue', trend: 'up' },
    { label: 'Page Views', value: totalPageViews, change: '+18%', icon: Eye, color: 'cyan', trend: 'up' },
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-white border-slate-200 rounded-xl p-4 shadow-sm">
            ...
            <tbody>
              {topPages.map((page, idx) => (
                ...
                >
                  ...
                  <td className="py-3 px-6 text-slate-600">{formatNumber(page.views)}</td>
